...
def _write_docx(path: Path, lines: Sequence[OCRLine], corrected: str,
    ...
    if lines:
        ...
        # text engine (e.g. Gemini): no per-line confidence/bbox
...
def export_all(image: np.ndarray, lines: Sequence[OCRLine],
               ...
               raw_text: Optional[str] = None) -> ExportResult:
    ...
    _write_docx(docx_path, lines, corrected, summary, raw_text=raw_text)
